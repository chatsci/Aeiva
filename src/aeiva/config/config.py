...
# coding=utf-8
"""
This module contains the config classes.
...
from aeiva.config.base_config import BaseConfig, OmniConfig
...
if __name__ == '__main__':
    # Creating OmniConfig instance
    OmniConfig.create_omni_config()

    # Now you can create a new instance of OmniConfig
    config = OmniConfig(
        dataset_path="./",
        dataset_name="customized",
        is_custom_dataset=False,
        customized_cache_dir=".cache/llm-ft/datasets",
    ...
    # # Or load it from a JSON or YAML file
    # config = OmniConfig.from_json("./config.json")
    # config = OmniConfig.from_yaml("./config.yaml")