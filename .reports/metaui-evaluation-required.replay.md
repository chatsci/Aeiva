...
- generated_at: `2026-02-10T02:53:41.074485+00:00`
- total_scenarios: `2`
- passed_scenarios: `0`
- failed_scenarios: `2`
- success_rate: `0.0000`
...
- [metaui_dialogue_ui_create] metaui_dialogue_ui_create/turn[0] MetaUI snapshot unavailable.
- [metaui_dialogue_ui_create] metaui_dialogue_ui_create/turn[0] MetaUI snapshot unavailable.
- [metaui_form_submit_flow] metaui_form_submit_flow/turn[0] response too short: 0 < 20
- [metaui_form_submit_flow] metaui_form_submit_flow/turn[0] latency 25.02s > 20.00s
- [metaui_form_submit_flow] metaui_form_submit_flow/turn[0] MetaUI snapshot unavailable.
- [metaui_form_submit_flow] metaui_form_submit_flow/turn[0] MetaUI snapshot unavailable.
